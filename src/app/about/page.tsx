              ...
              <div key={category} className='bg-secondary p-6 rounded-lg'>
                ...
                <div className='flex flex-wrap gap-2'>
                  {categorySkills.map((skill, index) => (
                    <Fragment key={index}>
                      {index === 0 ? '' : '-'}
                      <div className='text-gray-300 rounded-lg text-center hover:text-accent transition-colors'>
                        {skill}
                      </div>
                    </Fragment>
                  ))}
        ...
        <section className='mb-12'>
          ...
          <div className='bg-secondary p-6 rounded-lg'>
            ...
            <p className='text-gray-300'>
              Focused on web development and user interface design. Participated
              in various hackathons and web development competitions.
            </p>
          </div>
        </section>
